...
public class ElibraryAdapter extends RecyclerView.Adapter<ElibraryAdapter.ElibraryViewHolder> {
...
//    private List<String> favTopicList = new ArrayList<>();
    ...
    public ElibraryAdapter(Context context) {
...
//            throw new ClassCastException("Activity must implement AdapterCallback.", e);
    ...
    public ElibraryAdapter(Context context, Cursor cursor) {
        dataCursor = cursor;
        this.context = context;
    ...
    @Override
    public ElibraryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.single_item_elibrary_list, parent, false);
        ElibraryViewHolder myViewHolder = new ElibraryViewHolder(view);
...
//                listener.onItemClick(v, myViewHolder.getPosition());
    ...
    @Override
    public void onBindViewHolder(final ElibraryAdapter.ElibraryViewHolder holder, int position) {
...
//                }
    ...
    class ElibraryViewHolder extends RecyclerView.ViewHolder {
        ...
        public ElibraryViewHolder(View itemView) {
            super(itemView);
