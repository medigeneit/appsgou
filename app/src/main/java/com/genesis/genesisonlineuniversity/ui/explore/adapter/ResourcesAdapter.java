...
//            throw new ClassCastException("Activity must implement AdapterCallback.", e);
    ...
    public ResourcesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.single_item_resources_list, parent, false);
        ResourcesViewHolder myViewHolder = new ResourcesViewHolder(view);
...
//                listener.onItemClick(v, myViewHolder.getPosition());
    ...
    @Override
    public void onBindViewHolder(final ResourcesAdapter.ResourcesViewHolder holder, int position) {
