package com.genesis.genesisonlineuniversity.ui.explore.popular_programs.adapter;
...
public class AllPopularProgramsAdapter extends RecyclerView.Adapter<AllPopularProgramsAdapter.AllPopularProgramsViewHolder> {
...
//    private List<String> favTopicList = new ArrayList<>();
    ...
    public AllPopularProgramsAdapter(Context context) {
...
//            throw new ClassCastException("Activity must implement AdapterCallback.", e);
    ...
    public AllPopularProgramsAdapter(Context context, Cursor cursor) {
        dataCursor = cursor;
        this.context = context;
    ...
    @Override
    public AllPopularProgramsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.single_item_popular_topic_list, parent, false);
        AllPopularProgramsViewHolder myViewHolder = new AllPopularProgramsViewHolder(view);
...
//                listener.onItemClick(v, myViewHolder.getPosition());
    ...
    @Override
    public void onBindViewHolder(final AllPopularProgramsAdapter.AllPopularProgramsViewHolder holder, int position) {
...
//        }
    ...
    class AllPopularProgramsViewHolder extends RecyclerView.ViewHolder {
        ...
        public AllPopularProgramsViewHolder(View itemView) {
            super(itemView);
